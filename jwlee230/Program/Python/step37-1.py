"""
step37-1.py: Correlation with sites for Macrogen data
"""
import argparse
import itertools
...
if __name__ == "__main__":
    ...
    input_data.columns = list(map(lambda x: x.split("-")[-1], list(input_data.columns)))
    input_data = input_data.iloc[:, 1:]
    input_data = input_data.groupby(level=0, axis="columns").mean()
    print(input_data)
