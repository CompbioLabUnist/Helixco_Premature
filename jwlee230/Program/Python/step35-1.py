"""
step35-1.py: Draw cluster map plot within bacteria for Macrogen data
"""
import argparse
import itertools
...
if __name__ == "__main__":
    ...
    input_data.columns = list(map(lambda x: step00.simplified_taxonomy(x[0]) +f"f({x[1]})", list(input_data.columns)))
