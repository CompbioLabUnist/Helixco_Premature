"""
step80.py: Support Vector Classifier with DAT-union
"""
import argparse
import itertools
import tarfile
...
if __name__ == "__main__":
    ...
    classifier = sklearn.svm.SVC(probability=True, decision_function_shape="ovo", random_state=42, class_weight="balanced")
