"""
step77.py: K-Nearest Neighbor Classifier with DAT-union
"""
import argparse
import itertools
import tarfile
...
if __name__ == "__main__":
    ...
    classifier = sklearn.neighbors.KNeighborsClassifier(weights="distance", algorithm="brute", n_jobs=args.cpus)
