"""
step79.py: Neural Network Classifier with DAT-union
"""
import argparse
import itertools
import tarfile
...
if __name__ == "__main__":
    ...
    classifier = sklearn.neural_network.MLPClassifier(learning_rate="adaptive", random_state=42, max_iter=1000, solver="sgd")
    ...
    best_features = list(map(lambda x: x[1], sorted(zip(std, taxa), reverse=False)))
