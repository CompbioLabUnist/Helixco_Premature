...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{block}{PTB}
            \begin{itemize}
                \item Mother $\Rightarrow$ Early PTB: 17 \& Late PTB: 22 \& Normal: 29
                \item Newborn $\Rightarrow$ Early PTB: 13 \& Late PTB: 24 \& Normal: 22
            \end{itemize}
        \end{block}
        \pagebreak
