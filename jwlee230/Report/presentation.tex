...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/Step39/everything/everything.DADA2.jaccard.pdf}
            \caption{Cluster map with Jaccard distance index for DADA2}
        \end{figure}
    \end{frame}

    \subsection{Cluster-map}
    \begin{frame}
        \frametitle{Cluster map with samples \& bacteria}

        \begin{figure}
            \includegraphics[width=0.7 \linewidth]{figures/Step38/everything/everything.DADA2.gg.png}
            \caption{Cluster map with samples \& bacteria from DADA2 + GG}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/Step35/Everything/DADA2/gg/everything.DADA2.gg.spearman.png}
            \caption{Spearman correlation with DADA2+GG}
        \end{figure}
    \end{frame}

    \subsection{Shared Taxonomy}
    \begin{frame}
