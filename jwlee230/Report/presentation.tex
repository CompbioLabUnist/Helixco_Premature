...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.3 \linewidth]{figures/Step63/everything.DADA2.homd.Mouth.pdf}
                &
                \includegraphics[width=0.5 \linewidth]{figures/Step63/everything.DADA2.homd.Mouth.PTB.pdf}
                \\
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.3 \linewidth]{figures/Step68/everything.DADA2.homd.Mouth.Up.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step68/everything.DADA2.homd.Mouth.Down.pdf}
                \\
                \mbox{(a) Up-regulated DAT} & \mbox{(b) Down-regulated DAT} \\
            \end{array}$
            \caption{DAT Venn diagram}
        \end{figure}

        \begin{block}{Union of DAT}
            A total of 19 taxa selected as DAT.
        \end{block}
    \end{frame}
