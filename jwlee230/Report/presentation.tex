...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step55/everything.DADA2.homd.uncorrected/All+Data.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step55/everything.DADA2.homd.corrected/All+Data.pdf}
                \\
                \mbox{(a) Uncorrected} & \mbox{(b) Corrected} \\
            \end{array}$
            \caption{t-SNE plot before \& after batch correction}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step53/everything.DADA2.homd.uncorrected.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step53/everything.DADA2.homd.corrected.pdf}
                \\
                \mbox{(a) Uncorrected} & \mbox{(b) Corrected} \\
            \end{array}$
            \caption{Abundance distribution before \& after batch correction}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step49-2/everything.Deblur.homd.pearson.Sites/Neonate-1day.pdf}
                \\
