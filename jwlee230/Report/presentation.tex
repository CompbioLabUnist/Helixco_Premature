        ...
        \begin{columns}
            \begin{column}{0.4 \linewidth}
                \begin{figure}
                    ...
                    \caption{P. gingivalis}
                \end{figure}
            \end{column}
            \begin{column}{0.6 \linewidth}
                \begin{block}{P. gingivalis}
                    \begin{itemize}
                        ...
                        \item \text{P. gingivalis} $\Rightarrow$ Adverse prenancy outcomes \cite{Porphyromonas-2}.
                    \end{itemize}
                \end{block}
            \end{column}
        \end{columns}

        \begin{block}{Prevotella spp.}
            \begin{itemize}
        ...
        \begin{columns}
            \begin{column}{0.4 \linewidth}
                \begin{figure}
                    ...
                    \caption{P. pleuritidis}
                \end{figure}
            \end{column}
            \begin{column}{0.6 \linewidth}
                \begin{block}{P. pleuritidis}
                    \begin{itemize}
