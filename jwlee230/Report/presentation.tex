...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.45 \linewidth]{figures/QualityFilter/WholeForward.png}
                &
                \includegraphics[width=0.45 \linewidth]{figures/QualityFilter/WholeReverse.png}
                \\
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Bacterial Abundance}
    \end{frame}
