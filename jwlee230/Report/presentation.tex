...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            \includegraphics[width=0.5 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.Mouth.pdf}
            \caption{Differentially abundant taxa in Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.EL.Mouth.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.EF.Mouth.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.LF.Mouth.pdf}
                \\
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step61/everything.DADA2.homd.uncorrected.Mouth/S. sp. HMT 442.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step61/everything.DADA2.homd.uncorrected.Mouth/B. sp. HMT 206.pdf}
                \\
                \mbox{(a) \textit{Selenomonas} sp. \textit{HMT 442}} & \mbox{(b) \textit{Bergeyella} sp. \textit{HMT 206}} \\
            \end{array}$
            \caption{Up-regulated taxa}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step61/everything.DADA2.homd.uncorrected.Mouth/P. bacterium HMT 081.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step61/everything.DADA2.homd.uncorrected.Mouth/S. sp. HMT 134.pdf}
                \\
                \mbox{(a) \textit{P. bacterium HMT 081}} & \mbox{(b) \textit{Selenomonas} sp. \textit{HMT 134}} \\
            \end{array}$
            \caption{Down-regulated taxa}
        \end{figure}
    \end{frame}
