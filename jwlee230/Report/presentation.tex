...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{enumerate}
            ...
            \item Detail premature \& Premature
            \item Dyspnea
            \item Gender
            \item Gestational diabetes for maternity
            \item Gestational week (Gestational age)
            \item Hospitalized day
            \item Hypertension for maternity
            \item LGA (Large for GA) \& SGA (Small for GA)
            \item Maternal age
            \item Antibiotic usage for maternity \& for neonate
            \item PROM (Premature rupture of membranes)
            \item Preterm labor
            \item Usage of respirator for neonate
            \item Sepsis against neonate
            \item Birth weight of neonate
        \end{enumerate}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/tSNE/everything.DADA2.gg/Premature.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/tSNE/everything.DADA2.gg/Detail_Premature.pdf}
                \\
                \mbox{(a) Premature} & \mbox{(b) Detail Premature} \\
            \end{array}$
            \caption{Selected t-SNE Plots (PTBs)}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/C-section.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/Gender.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/Newborn_Antibiotics.pdf}
                \\
                \mbox{(a) C-section} & \mbox{(b) Gender} & \mbox{(c) Antibiotics} \\
            \end{array}$
            \caption{Selected t-SNE Plots (Not severe condition)}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/PROM.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/Sepsis.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/tSNE/everything.DADA2.gg/Respirator.pdf}
                \\
                \mbox{(a) PROM} & \mbox{(b) Sepsis} & \mbox{(c) Usage of Respirator} \\
            \end{array}$
            \caption{Selected t-SNE Plots (Severe conditions)}
        \end{figure}

        \begin{figure}
            \includegraphics[width=0.6 \linewidth]{figures/tSNE/everything.DADA2.gg/Site.pdf}
            \caption{t-SNE Plot with Site}
        \end{figure}
    \end{frame}
