...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}[h!]
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/TSNE/Brief/DB.DADA2.gg.png}
                &
                \includegraphics[width=0.4 \linewidth]{figures/TSNE/Brief/DB.DADA2.silva.png}
                \\
        ...
        \begin{figure}[h!]
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/TSNE/Brief/DB.Deblur.gg.png}
                &
                \includegraphics[width=0.4 \linewidth]{figures/TSNE/Brief/DB.Deblur.silva.png}
                \\
    ...
    \begin{frame}[allowframebreaks]
        ...
        \end{figure}
        \textit{Bacteria Fusobacteriota Fusobacteriia Fusobacteriales Leptotrichiaceae Leptotrichia}
    \end{frame}
