...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \\
            \end{array}$
            \caption{Alpha-diversities by DADA2 \& Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Mouth+Obesity+faith_pd.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Mouth+Obesity+observed_features.pdf}
                \\
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Mouth+Obesity+pielou_evenness.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Mouth+Obesity+shannon_entropy.pdf}
                \\
            \end{array}$
            \caption{Alpha-diversities by Deblur \& Overweight/Obesity in Maternal Mouth}
        \end{figure}
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \\
            \end{array}$
            \caption{Alpha-diversities by DADA2 \& Overweight/Obesity in Neonatal-3day}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Neonate-3day+Obesity+faith_pd.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Neonate-3day+Obesity+observed_features.pdf}
                \\
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Neonate-3day+Obesity+pielou_evenness.pdf}
                &
                \includegraphics[width=0.25 \linewidth]{figures/AlphaDiversity/everything.Deblur/Neonate-3day+Obesity+shannon_entropy.pdf}
                \\
            \end{array}$
            \caption{Alpha-diversities by Deblur \& Overweight/Obesity in Neonatal-3day}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.bray_curtis/Mouth+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.jaccard/Mouth+Obesity.pdf}
                \\
                \mbox{(a) Bray-Curitis} & \mbox{(b) Jaccard} \\

                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.unweighted_unifrac/Mouth+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.weighted_unifrac/Mouth+Obesity.pdf}
                \\
                \mbox{(c) Unweighted UniFrac} & \mbox{(d) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by DADA2 \& Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.bray_curtis/Mouth+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.jaccard/Mouth+Obesity.pdf}
                \\
                \mbox{(a) Bray-Curitis} & \mbox{(b) Jaccard} \\

                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.unweighted_unifrac/Mouth+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.weighted_unifrac/Mouth+Obesity.pdf}
                \\
                \mbox{(c) Unweighted UniFrac} & \mbox{(d) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by Deblur \& Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.bray_curtis/Neonate-3day+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.jaccard/Neonate-3day+Obesity.pdf}
                \\
                \mbox{(a) Bray-Curitis} & \mbox{(b) Jaccard} \\

                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.unweighted_unifrac/Neonate-3day+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/DADA2/everything.weighted_unifrac/Neonate-3day+Obesity.pdf}
                \\
                \mbox{(c) Unweighted UniFrac} & \mbox{(d) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by DADA2 \& Overweight/Obesity in Neonate 3-day}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.bray_curtis/Neonate-3day+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.jaccard/Neonate-3day+Obesity.pdf}
                \\
                \mbox{(a) Bray-Curitis} & \mbox{(b) Jaccard} \\

                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.unweighted_unifrac/Neonate-3day+Obesity.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/BetaDiversity/Deblur/everything.weighted_unifrac/Neonate-3day+Obesity.pdf}
                \\
                \mbox{(c) Unweighted UniFrac} & \mbox{(d) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by Deblur \& Overweight/Obesity in Neonate 3-day}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{LEfSe Results with PTB}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Default/everything.DADA2.gg.Neonate-1day.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Default/everything.Deblur.gg.Neonate-1day.pdf}
                \\
                \mbox{(a) DADA2+GG} & \mbox{(b) Deblur+GG} \\

                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Default/everything.Deblur.silva.Neonate-1day.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Default/everything.Deblur.homd.Neonate-1day.pdf}
                \\
                \mbox{(c) Deblur+Silva} & \mbox{(d) Deblur+HOMD} \\
            \end{array}$
            \caption{LEfSe in Neonate 1-day}
        \end{figure}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Obesity-Default/everything.Deblur.gg.Cervix.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Obesity-Default/everything.Deblur.silva.Cervix.pdf}
                \\
                \mbox{(a) Deblur+GG} & \mbox{(b) Deblur+Silva} \\

                \includegraphics[width=0.4 \linewidth]{figures/LEfSe/Obesity-Default/everything.Deblur.homd.Cervix.pdf}
                &
                \\
                \mbox{(c) Deblur+HOMD} & \\
            \end{array}$
            \caption{LEfSe in Cervix}
        \end{figure}

        \begin{figure}
            \includegraphics[width=\linewidth]{figures/LEfSe/Obesity-Default/everything.DADA2.gg.Vagina.pdf}
            \caption{DADA2+GG in Vagina}
        \end{figure}
    \end{frame}
