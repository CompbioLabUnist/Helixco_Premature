...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+heip_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+heip_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+heip_e.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Heip $e$}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+simpson_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+simpson_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+simpson_e.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Simpson $e$}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+pielou_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+pielou_e.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+pielou_e.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Pielou $e$}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+brillouin_d.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+brillouin_d.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+brillouin_d.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Brillouin $d$}
        \end{figure}

         \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+enspie.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+enspie.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+enspie.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Enspie}
        \end{figure}

         \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Detail_Premature+robbins.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Detail_Premature+robbins.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-5day+Detail_Premature+robbins.pdf}
                \\
                \mbox{(a) Mother Mouth} & \mbox{(b) Neonate 3-day} & \mbox{(c) Neonate 5-day} \\
            \end{array}$
            \caption{Detail premature \& Robbins}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/Step40/everything/everything.DADA2.gg.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step40/everything/everything.DADA2.silva.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step40/everything/everything.DADA2.homd.pdf}
                \\
                \mbox{(a) GG} & \mbox{(b) Silva} & \mbox{(c) HOMD} \\
            \end{array}$
            \caption{Shared Taxonomy with Neonates \& Mothers from DADA2}
        \end{figure}
    \end{frame}
