...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(a) All} & \mbox{(b) Mother Mouth} \\
            \end{array}$
            \caption{t-SNE plot of Abundance with Premature}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                ...
                \mbox{(a) All} & \mbox{(b) Mother Mouth} \\
            \end{array}$
            \caption{t-SNE plot of Proportion with Proportion}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step49/everything.DADA2.homd.spearman.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step49/everything.DADA2.homd.spearman.Sites/Mouth.pdf}
                \\
                \mbox{(a) All} & \mbox{(b) Mouth} \\
            \end{array}$
            \caption{Spearman correlation on Taxonomy Abundance}
        \end{figure}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/Step49_Proportion/everything.DADA2.homd.spearman.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/Step49_Proportion/everything.DADA2.homd.spearman.Sites/Mouth.pdf}
                \\
                \mbox{(a) All} & \mbox{(b) Mouth} \\
            \end{array}$
            \caption{Spearman correlation on Taxonomy Proportion}
        \end{figure}
    \end{frame}
