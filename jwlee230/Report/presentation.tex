...
%    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.Mouth.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.Vagina.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/Step44/everything.DADA2.homd.uncorrected.Cervix.pdf}
                \\
                \mbox{(a) Mouth} & \mbox{(b) Vagina} & \mbox{(c) Cervix} \\
            \end{array}$
            \caption{Deferentially abundant taxa}
        \end{figure}
    \end{frame}
