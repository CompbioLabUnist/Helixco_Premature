...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/TSNE/Brief/DB.DADA2.gg.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/TSNE/Brief/DB.DADA2.silva.pdf}
                \\
                \mbox{(a) DADA2 + GG} & \mbox{(b) DADA2 + SILVA} \\

                \includegraphics[width=0.2 \linewidth]{figures/TSNE/Brief/DB.Deblur.gg.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/TSNE/Brief/DB.Deblur.silva.pdf}
                \\
                \mbox{(c) Deblur + GG} & \mbox{(d) Deblur + SILVA} \\
            \end{array}$
