...
\begin{document}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Gestational_Diabetes.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Gestational_Diabetes.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Observed Features} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Too_much_weight_gain.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Too_much_weight_gain.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Observed Features} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Overweight_or_Obesity.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Overweight_or_Obesity.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Features} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Hypertension.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Hypertension.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Observed Features} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+PROM.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+PROM.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Observed Features}  \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Mother_Antibiotics.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Mother_Antibiotics.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Observed Features} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/faith_pd+Mother_Steroid.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/AlphaDiversity/everything.DADA2/observed_features+Mother_Steroid.pdf}
                \\
                \mbox{(a) Faith PD} & \mbox{(b) Features} \\
            \end{array}$
            \caption{Alpha Diversity upon Maternal Steroid Usage}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Gestational_Diabetes.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Gestational_Diabetes.pdf}
                \\
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Too_much_weight_gain.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Too_much_weight_gain.pdf}
                \\
                \mbox{(a) Bray-Curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Overweight_or_Obesity.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Overweight_or_Obesity.pdf}
                \\
                \mbox{(a) Bray-Curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Hypertension.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Hypertension.pdf}
                \\
                \mbox{(a) Bray-Curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/PROM.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/PROM.pdf}
                \\
                \mbox{(a) Bray-Curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Mother_Antibiotics.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Mother_Antibiotics.pdf}
                \\
                \mbox{(a) Bray-curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
        ...
        \begin{figure}
            $\begin{array}{cccc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.bray_curtis/Mother_Steroid.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/everything.jaccard/Mother_Steroid.pdf}
                \\
                \mbox{(a) Bray-curtis} & \mbox{(b) Jaccard} \\
            \end{array}$
            \caption{Beta-diversity upon Maternal Steroid Usage}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item One of the best machine learning techniques
            \item Give importance of each feature
        \end{itemize}
    \end{frame}

    \begin{frame}[allowframebreaks]
        \frametitle{Random Forest Classifier Results}

        762 features $\Rightarrow$ 219 features

        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/RandomForest/RF.DADA2.gg/importances.pdf}
            \caption{Feature Importances}
        \end{figure}

        \begin{figure}
            \includegraphics[width=0.8 \linewidth]{figures/RandomForest/RF.DADA2.gg/metrics.pdf}
            \caption{Classification Metrics by Features}
        \end{figure}

        \begin{figure}
            $\begin{array}{ccc}
                \includegraphics[width=0.3 \linewidth]{figures/RandomForest/RF.DADA2.gg/Violin_0.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/RandomForest/RF.DADA2.gg/Violin_1.pdf}
                &
                \includegraphics[width=0.3 \linewidth]{figures/RandomForest/RF.DADA2.gg/Violin_2.pdf}
                \\
            \end{array}$
            \caption{Most Important three Features}
        \end{figure}
    \end{frame}
