...
\begin{document}
    ...
    \begin{frame}
        ...
        \begin{itemize}
            \item Alpha diversity indices
            \begin{enumerate}
                \item Fisher alpha
                \item Observed OTUs
                \item Pielou eveness
                \item Shannon Entropy
                \item Total: 22 diversity indicies
            \end{enumerate}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Alpha-diversity Violin Plots with Overweight/Obesity}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Obesity+fisher_alpha.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Obesity+observed_otus.pdf}
                \\
                \mbox{(a) Fisher alpha} & \mbox{(b) Observed OTUs} \\
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Obesity+pielou_e.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Mouth+Obesity+shannon.pdf}
                \\
                \mbox{(c) Pielou evenness} & \mbox{(d) Shannon} \\
            \end{array}$
            \caption{Alpha-diversities by Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Obesity+fisher_alpha.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Obesity+observed_otus.pdf}
                \\
                \mbox{(a) Fisher alpha} & \mbox{(b) Observed OTUs} \\
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Obesity+pielou_e.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/Macrogen/Neonate-3day+Obesity+shannon.pdf}
                \\
                \mbox{(c) Pielou evenness} & \mbox{(d) Shannon} \\
            \end{array}$
            \caption{Alpha-diversities by Overweight/Obesity in Neonatal-3day}
        \end{figure}
    \end{frame}

    \begin{frame}[allowframebreaks]
        \frametitle{Alpha-diversity Violin Plot with Data Batch}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Mouth+Obesity+fisher_alpha.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Mouth+Obesity+observed_otus.pdf}
                \\
                \mbox{(a) Fisher alpha} & \mbox{(b) Observed OTUs} \\
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Mouth+Obesity+pielou_e.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Mouth+Obesity+shannon.pdf}
                \\
                \mbox{(c) Pielou evenness} & \mbox{(d) Shannon} \\
            \end{array}$
            \caption{Alpha-diversities by First Batch \& Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Neonate-3day+Obesity+fisher_alpha.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Neonate-3day+Obesity+observed_otus.pdf}
                \\
                \mbox{(a) Fisher alpha} & \mbox{(b) Observed OTUs} \\
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Neonate-3day+Obesity+pielou_e.pdf}
                &
                \includegraphics[width=0.2 \linewidth]{figures/AlphaDiversity/First.Macrogen/Neonate-3day+Obesity+shannon.pdf}
                \\
                \mbox{(c) Pielou evenness} & \mbox{(d) Shannon} \\
            \end{array}$
            \caption{Alpha-diversities by First Batch \& Overweight/Obesity in Neonatal-3day}
        \end{figure}
    \end{frame}
    ...
    \begin{frame}[allowframebreaks]
        \frametitle{Beta-diversity Scatter Plots with Overweight/Obesity}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.unweighted_unifrac/Mouth+Obesity.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.weighted_unifrac/Mouth+Obesity.pdf}
                \\
                \mbox{(a) Unweighted UniFrac} & \mbox{(b) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by Overweight/Obesity in Maternal Mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.unweighted_unifrac/Neonate-3day+Obesity.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.weighted_unifrac/Neonate-3day+Obesity.pdf}
                \\
                \mbox{(a) Unweighted UniFrac} & \mbox{(b) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by Overweight/Obesity in Neonate 3-day}
        \end{figure}
    \end{frame}

    \begin{frame}[allowframebreaks]
        \frametitle{Beta-diversity Scatter plot with Data Batch}

         \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.unweighted_unifrac/Mouth+Data.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.weighted_unifrac/Mouth+Data.pdf}
                \\
                \mbox{(a) Unweighted UniFrac} & \mbox{(b) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by First Batch in Maternal mouth}
        \end{figure}

        \begin{figure}
            $\begin{array}{cc}
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.unweighted_unifrac/Neonate-3day+Data.pdf}
                &
                \includegraphics[width=0.4 \linewidth]{figures/BetaDiversity/Macrogen/everything.weighted_unifrac/Neonate-3day+Data.pdf}
                \\
                \mbox{(a) Unweighted UniFrac} & \mbox{(b) Weighted UniFrac} \\
            \end{array}$
            \caption{Beta-diversities by First Batch in Neonate 3-day}
        \end{figure}
    \end{frame}
